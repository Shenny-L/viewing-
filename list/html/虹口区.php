...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="container" style="font-family: '微软雅黑'"> <a class="navbar-brand justify-content-start" href="虹口区.php" style="font-size: 50px">虹口区</a>
...
<div id="top" style="width: 100%;height: 400px;overflow:hidden"> <img src="../image/虹口区.jpg" alt="head" style="width: 100%;-webkit-filter: blur(4px);filter: blur(4px);">
  <div style="position: absolute; top: 200px; left: 150px; font-family: '华文细黑'; font-size: 5em; color:azure">虹口区</div>
</div>
<div class="container" style="margin: auto;margin-top: 30px;">
  <div class="row">
    <div class="col-12 col-xl-12">
      <div class="card" style="border: thin;background-color:black" onMouseMove="fucusOn(this)" onMouseOut="deFucusOn(this)" > <img src="../../景点介绍/image/多伦路文化名人街/多伦路文化名人街.jpg" alt="Card image cap" width="100%" class="card-img-top"  >
        <div class="card-body" style="position: absolute; color: aliceblue; display: none">
          <h1 class="card-title">多伦路文化名人街</h1>
          <p class="card-text">多伦路（原名窦乐安路）是上海的一条小街，位于虹口区东江湾路146号，南傍四川北路商贸闹市，
                    北邻鲁迅公园、虹口足球场，背靠内环高架、轻轨3号线，动静相间一里有余。街短而窄，却蜿蜒蛇行，曲径道幽。
                    夹街小楼，栉比鳞次，风格各异。小街虽在地图上难有立锥之地，但在近现代中国文化史上却是浓墨重彩的一笔。</p>
          <a href="../../景点介绍/多伦路文化名人街_7.php" class="btn btn-primary" style="position:relative;">浏览详情</a> </div>
      </div>
    </div>
  </div>
</div>
<div class="container" style="margin: auto;margin-top: 30px;">
  <div class="row">
    <div class="col-12 col-xl-12">
      <div class="card" style="border: thin;background-color:black" onMouseMove="fucusOn(this)" onMouseOut="deFucusOn(this)" > <img src="../../景点介绍/image/鲁迅故居/luxunguju.jpg" alt="Card image cap" width="100%" class="card-img-top"  >
        <div class="card-body" style="position: absolute; color: aliceblue; display: none">
          <h1 class="card-title">鲁迅故居</h1>
          <p class="card-text">鲁迅1927年10月从广州来到上海，到1936年10月19日逝世，在上海整整生活了九年。
                    在上海期间他陆续出版了9本杂文集和历史小说集《故事新编》，先后编辑《语丝》、
                    《奔流》、《朝花》、《萌芽》、《前哨》、《十字街头》、《译文》等文学刊物，
                    翻译了许多外国文学作品，1929年主编《科学的艺术论丛书》。
                    他拥护中国共产党提出的抗日民族统一战线的方针，提出“民族革命战争的大众文学”的口号。</p>
          <a href="../../景点介绍/鲁迅故居_11.php" class="btn btn-primary" style="position:relative;">浏览详情</a> </div>
      </div>
    </div>
  </div>
</div>
