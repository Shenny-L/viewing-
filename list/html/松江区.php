...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="container" style="font-family: '微软雅黑'"> <a class="navbar-brand justify-content-start" href="松江区.php" style="font-size: 50px">松江区</a>
...
<div id="top" style="width: 100%;height: 400px;overflow:hidden"> <img src="../image/松江区.jpg" alt="head" style="width: 100%;-webkit-filter: blur(4px);filter: blur(4px);">
  <div style="position: absolute; top: 200px; left: 150px; font-family: '华文细黑'; font-size: 5em; color:azure">松江区</div>
</div>
<div class="container" style="margin: auto;margin-top: 30px;">
  <div class="row">
    <div class="col-12 col-xl-12">
      <div class="card" style="border: thin;background-color:black" onMouseMove="fucusOn(this)" onMouseOut="deFucusOn(this)" > <img src="../../景点介绍/image/上海欢乐谷/背景.jpg" alt="Card image cap" width="100%" class="card-img-top"  >
        <div class="card-body" style="position: absolute; color: aliceblue; display: none">
          <h1 class="card-title">上海欢乐谷</h1>
          <p class="card-text">上海欢乐谷位于上海西南部的松江佘山国家旅游度假区内，距上海市中心区40千米，离虹桥国际机场25千米、浦东国际机场68千米。2009年9月12日，上海欢乐谷建成开业；2014年7月，上海欢乐谷二期“欢乐海洋主题区”开放；2016年暑期，上海玛雅水公园2期“魔力水城”正式对外开放 [1-2] 。上海欢乐谷全园占地面积65万平方米，拥有100多项体验项目，上海欢乐谷全园共有七大主题区：阳光港、欢乐时光、上海滩、香格里拉、欢乐海洋、金矿镇、飓风湾。</p>
          <a href="../../景点介绍/上海欢乐谷_29.php" class="btn btn-primary" style="position:relative;">浏览详情</a> </div>
      </div>
    </div>
  </div>
</div>
<div class="container" style="margin: auto;margin-top: 30px;">
  <div class="row">
    <div class="col-12 col-xl-12">
      <div class="card" style="border: thin;background-color:black" onMouseMove="fucusOn(this)" onMouseOut="deFucusOn(this)" > <img src="../../景点介绍/image/佘山/背景.jpg" alt="Card image cap" width="100%" class="card-img-top"  >
        <div class="card-body" style="position: absolute; color: aliceblue; display: none">
          <h1 class="card-title">佘山</h1>
          <p class="card-text">佘山，位于中国上海市松江区，分西佘山跟东佘山。西佘山海拔100.8米（2004年前标定为99米）（一说97米），是上海境内第二高峰，上海陆地第一高峰；东佘山海拔72.4米。</p>
          <a href="../../景点介绍/佘山_33.php" class="btn btn-primary" style="position:relative;">浏览详情</a> </div>
      </div>
    </div>
  </div>
</div>
