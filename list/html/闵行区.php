...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="container" style="font-family: '微软雅黑'"> <a class="navbar-brand justify-content-start" href="闵行区.php" style="font-size: 50px">闵行区</a>
...
<div id="top" style="width: 100%;height: 400px;overflow:hidden"> <img src="../image/闵行区.jpg" alt="head" style="width: 100%;-webkit-filter: blur(4px);filter: blur(4px);">
  <div style="position: absolute; top: 200px; left: 150px; font-family: '华文细黑'; font-size: 5em; color:azure">闵行区</div>
</div>
<div class="container" style="margin: auto;margin-top: 30px;">
  <div class="row">
    <div class="col-12 col-xl-12">
      <div class="card" style="border: thin;background-color:black" onMouseMove="fucusOn(this)" onMouseOut="deFucusOn(this)" > <img src="../../景点介绍/image/七宝古镇/背景.jpg" alt="Card image cap" width="100%" class="card-img-top"  >
        <div class="card-body" style="position: absolute; color: aliceblue; display: none">
          <h1 class="card-title">七宝古镇</h1>
          <p class="card-text">七宝镇，位于上海市西南部，是一座既有江南水乡自然风光，又有悠久人文内涵的历史古镇。东临漕河泾高新技术开发区，西接松江、青浦，南靠上海市莘庄工业区，北邻虹桥国际机场。</p>
          <a href="../../景点介绍/七宝古镇_25.php" class="btn btn-primary" style="position:relative;">浏览详情</a> </div>
      </div>
    </div>
  </div>
</div>
