...
if(isset($_POST['comment'])&&$_POST['comment']!="")
{
    ...
    execute($link,$query);
    unset($_POST['comment']);
    header("location:汇龙潭_23.php?view='comment'");
}
opHeader();
if(!isset($_GET['view']))
{
...
<div  style="font-size:15px;margin:0px auto 0px 550px;">
    <a style="color:#00CCFF;text-decoration: 0;"href=汇龙潭_23.php?sortWay="time"&view="comment">按时间</a>
    &nbsp|&nbsp
    <a style="color:#00CCFF;text-decoration: 0;"href=汇龙潭_23.php?sortWay="likes"&view="comment">按赞数</a>
</div>
<br/>
</div>
A;
...
while ($data=mysqli_fetch_assoc($result))
{
    ...
    <div class="thumb">
    <a id={$thumbId} href=comment_like.php?id={$data['id'] }&URL="汇龙潭_23.php">
    ...
    <span style="color:gray";font-size:10px;>{$data['time']}&nbsp&nbsp&nbsp
        <a style="color:#0099FF; font-size:15px; text-decoration: 0;" href=comment_del.php?id={$data['id'] }&URL="汇龙潭_23.php">删除</a>
    <span>
    </div>
    </div>
    </div>
    ...
    <div class="js">
        <div class="jianjie">
            <div class="words">
                <h3>简介</h3>
                <p>
                    汇龙潭于明代万历十六年（1588）所建，自北向南有五条河流汇集而成，应奎山坐落潭中，绿水怀抱，宛如一颗明珠，自古有五龙抢珠之称，汇龙潭因此而得名。园内布局分为南北两大部分。南部是应奎山和汇龙潭组成的自然山水风景。登上应奎山的四宜亭，俯视四周，魁星阁、玉虹桥、碧荷池、打唱台等尽收眼底。
                </p>
                <p>
            ...
            <div class="img">
                <img src="image/汇龙潭/简介.jpg" alt="简介">
            </div>
        </div>
        <div class="main">
            <h3>景点历史</h3>
            <div class="scen1">
                <div class="img">
                    <img src="image/汇龙潭/应奎山.jpg" alt="应奎山">
                </div>
                <div class="words">
                    <h4>应奎山</h4>
                    <p>
                        潭中有山岛一座，名叫应奎山，筑于明代顺四年（1460）。山巅新构一亭，名凌云亭，立亭内可俯瞰汇龙潭全景。民国17年（1928）嘉定县通俗教育馆将汇龙潭、应奎山、魁星阁、龙门桥、孔庙一带风景优美之处改建为公园。将原有树木建筑经过整修，于第二年二月正式对外开放，取名“奎山公园”，这是汇龙潭公园前身，也是嘉定最早的公园。
                    </p>
                    <p>登上应奎山的四宜亭，俯视四周，魁星阁、玉虹桥、碧荷池、打唱台等尽收眼底。“打唱台”是一座金碧辉煌、精雕细刻的“百鸟朝凤”台，始建于1888年，为上海闸北区钱业会馆里的一座戏台，1976年迁入此园。公园的北部景点相对集中，有碎玉泉 、夕照亭、芭蕉小院、玉莲池等，错落有致异常精巧。
                    </p>
                </div>
            </div>
            <div class="scen2">
                ...
                <div class="img">
                    <img src="image/汇龙潭/奎山公园.jpg" alt="奎山公园">
                </div>
            </div>
            <div class="scen3">
                <div class="words">
                ...
                <div class="img">
                    <img src="image/汇龙潭/潭水泛赤.jpg" alt="潭水泛赤">
                </div>
            </div>
            <div class="scen4">
                <div class="img">
                    <img src="image/汇龙潭/文化古迹.jpg" alt="文化古迹">
                </div>
                <div class="words">
                    <h4>文化古迹</h4>
                    <p>
                        园内历史文化古迹颇多，有宋、元、明、清朝代的石亭、石塔、石峰等文物古迹；百年以上的古树名木十一棵。古朴浑厚，保存完整，是历史文化艺术之精品。候黄二先生纪念碑与小刀会就义遗址的业绩古树给游客游园增添不少情趣。徜徉与古朴秀美的幽境，如入桃源之中，极富诗情画意。
                    </p>
                </div>
            </div>
        </div>
...
<body>
    ...
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="汇龙潭_23.php?view='intro'">看介绍</a> 
    </div>
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="汇龙潭_23.php?view='comment'">看评论</a>
    </div>
    <?php
    if(!isset($_GET['view']))
    {
...
function opHeader()
{
    ...
    <link rel="stylesheet" href="css/汇龙潭.css">
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container" style="font-family: '微软雅黑'">
            <a class="navbar-brand justify-content-start" href="#" style="font-size: 30px">汇龙潭</a>
