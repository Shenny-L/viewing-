...
if(isset($_POST['comment'])&&$_POST['comment']!="")
{
    ...
    execute($link,$query);
    unset($_POST['comment']);
    header("location:上海植物园_32.php?view='comment'");
}
opHeader();
if(!isset($_GET['view']))
{
...
<div  style="font-size:15px;margin:0px auto 0px 550px;">
    <a style="color:#00CCFF;text-decoration: 0;"href=上海植物园_32.php?sortWay="time"&view="comment">按时间</a>
    &nbsp|&nbsp
    <a style="color:#00CCFF;text-decoration: 0;"href=上海植物园_32.php?sortWay="likes"&view="comment">按赞数</a>
</div>
<br/>
</div>
A;
...
while ($data=mysqli_fetch_assoc($result))
{
    ...
    <div class="thumb">
    <a id={$thumbId} href=comment_like.php?id={$data['id'] }&URL="上海植物园_32.php">
    ...
    <span style="color:gray";font-size:10px;>{$data['time']}&nbsp&nbsp&nbsp
        <a style="color:#0099FF; font-size:15px; text-decoration: 0;" href=comment_del.php?id={$data['id'] }&URL="上海植物园_32.php">删除</a>
    <span>
    </div>
    </div>
    </div>
    ...
    <div class="js">
        <div class="jianjie">
            <div class="words">
                <h3>简介</h3>
                <p>
                    上海植物园位于徐汇区西南部，前身为龙华苗圃，是一个以植物引种驯化和展示、园艺研究及科普教育为主的综合性植物园。1974年起筹建，1980年1月1日正式建园，占地81.86公顷。展览区设植物进化区、盆景园、草药园、展览温室、兰室和绿化示范区等15个专类园。上海植物园是国家AAAA级旅游景区。1996年，上海植物园被驻沪海外人士评为最喜爱的郊游目的地，2000年又被评为新千年“六一”好去处。
                </p>
            </div>
            <div class="img">
                <img src="image/上海植物园/简介.jpg" alt="简介">
            </div>
        </div>
        <div class="main">
            <h3>展区介绍</h3>
            <div class="scen1">
                <div class="img">
                    <img src="image/上海植物园/植物进化区.jpg" alt="植物进化区">
                </div>
                <div class="words">
                    <h4>植物进化区</h4>
                    <p>
            ...
            <div class="scen2">
                ...
                <div class="img">
                    <img src="image/上海植物园/人工生态区.jpg" alt="人工生态区">
                </div>
            </div>
            <div class="scen3">
                <div class="img">
                    <img src="image/上海植物园/环境保护区.jpg" alt="环境保护区">
                </div>
                <div class="words">
                    <h4>环境保护区</h4>
                    <p>
                        环境保护区位于上海植物园中部南面，占地3.07万平方米。区内种植对有害气体的抗性植物，包括能吸收有害气体的夹竹桃、臭椿、罗汉松、女贞、香樟、大叶黄杨、广玉兰、桑、构树等植物，以及能指示某种有害气体污染程度的雪松、金丝桃、酢浆草、桃等植物。 区内建混合结构环保宣传廊，面积144平方米。
                    </p>
                    <p>
                        本区主要是宣传发展绿化、保护环境的知识，向工矿企业推荐适用的环保树种。
                    </p>
                </div>
            </div>
        </div>
...
<body>
    ...
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="上海植物园_32.php?view='intro'">看介绍</a> 
    </div>
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="上海植物园_32.php?view='comment'">看评论</a>
    </div>
    <?php
    if(!isset($_GET['view']))
    {
...
function opHeader()
{
    ...
    <link rel="stylesheet" href="css/上海植物园.css">
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container" style="font-family: '微软雅黑'">
            <a class="navbar-brand justify-content-start" href="#" style="font-size: 30px">上海植物园</a>
