...
if(isset($_POST['comment'])&&$_POST['comment']!="")
{
    ...
    execute($link,$query);
    unset($_POST['comment']);
    header("location:玉佛寺_34.php?view='comment'");
}
opHeader();
if(!isset($_GET['view']))
{
...
<div  style="font-size:15px;margin:0px auto 0px 550px;">
    <a style="color:#00CCFF;text-decoration: 0;"href=玉佛寺_34.php?sortWay="time"&view="comment">按时间</a>
    &nbsp|&nbsp
    <a style="color:#00CCFF;text-decoration: 0;"href=玉佛寺_34.php?sortWay="likes"&view="comment">按赞数</a>
</div>
<br/>
</div>
A;
...
while ($data=mysqli_fetch_assoc($result))
{
    ...
    <div class="thumb">
    <a id={$thumbId} href=comment_like.php?id={$data['id'] }&URL="玉佛寺_34.php">
    ...
    <span style="color:gray";font-size:10px;>{$data['time']}&nbsp&nbsp&nbsp
        <a style="color:#0099FF; font-size:15px; text-decoration: 0;" href=comment_del.php?id={$data['id'] }&URL="玉佛寺_34.php">删除</a>
    <span>
    </div>
    </div>
    </div>
...
function opIntro()
{
    ...
    <div class="js">
        <div class="jianjie">
            ...
            <div class="img">
                <img src="image/玉佛寺/简介.jpg" alt="简介">
            </div>
        </div>
        <div class="main">
            <div class="scen1">
                <div class="img">
                    <img src="image/玉佛寺/建筑格局.jpg" alt="建筑格局">
                </div>
                <div class="words">
                    <h4>建筑格局</h4>
                    <p>
            ...
            <div class="scen2">
                <div class="words">
                    <h4>大雄宝殿</h4>
                    <p>
                        大雄宝殿是寺内的主体建筑，长约30米，宽约25米（宽7间，进深5间），外观为宋式两层宫殿式建筑，古朴庄严。殿正中是释迦牟尼佛，两侧分别是阿弥陀佛和药师佛，三尊大佛趺坐在莲花座上，神态安详。佛像通高4米，全身披金，使整个殿堂都显得金光灿烂肃穆庄严。释迥牟尼佛头顶上方的藻井上，绘述着释迦牟降生时的裸体法相和九龙吐水为他沐浴的漩涡形条纹图，生动有趣。
                    </p>
                </div>
                <div class="img">
                    <img src="image/玉佛寺/大雄宝殿.jpg" alt="大雄宝殿">
                </div>
            </div>
            <div class="scen3">
                <div class="img">
                    <img src="image/玉佛寺/文化交流.jpg" alt="文化交流">
                </div>
                <div class="words">
                    <h4>文化交流</h4>
                    <p>
                        玉佛寺自恢复开放以来，在对外接待方面也做了大量工作，成为上海市对外友好交往的一个重要窗口。据统计，从1981年至1989年，上海市的玉佛寺、龙华寺、静安寺三大寺共接待了2000多万人次，其中外宾250多万人次。凡是到上海参观访问的外宾几乎都前往寺庙参观，包括一些政府要人和各界著名人士，如美国前总统里根的夫人、巴西总统夫人、英国玛格丽特公主、泰国王储玛哈拉集拉萨先生、法国前总理皮埃尔、印度总理夫人、西哈努克亲王夫妇、澳大利亚总督、加拿大总督、港澳总督，以及港澳台和世界各国佛教界的高僧。
                    </p>
                </div>
            </div>
        </div>
...
<body>
    ...
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="玉佛寺_34.php?view='intro'">看介绍</a> 
    </div>
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="玉佛寺_34.php?view='comment'">看评论</a>
    </div>
    <?php
    if(!isset($_GET['view']))
    {
...
function opHeader()
{
    ...
    <link rel="stylesheet" href="css/玉佛寺.css">
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container" style="font-family: '微软雅黑'">
            <a class="navbar-brand justify-content-start" href="#" style="font-size: 30px">玉佛寺</a>
