...
if(isset($_POST['comment'])&&$_POST['comment']!="")
{
    ...
    execute($link,$query);
    unset($_POST['comment']);
    header("location:上海宋庆龄故居_30.php?view='comment'");
}
opHeader();
if(!isset($_GET['view']))
{
...
<div  style="font-size:15px;margin:0px auto 0px 550px;">
    <a style="color:#00CCFF;text-decoration: 0;"href=上海宋庆龄故居_30.php?sortWay="time"&view="comment">按时间</a>
    &nbsp|&nbsp
    <a style="color:#00CCFF;text-decoration: 0;"href=上海宋庆龄故居_30.php?sortWay="likes"&view="comment">按赞数</a>
</div>
<br/>
</div>
A;
...
while ($data=mysqli_fetch_assoc($result))
{
    ...
    <div class="thumb">
    <a id={$thumbId} href=comment_like.php?id={$data['id'] }&URL="上海宋庆龄故居_30.php">
    ...
    <span style="color:gray";font-size:10px;>{$data['time']}&nbsp&nbsp&nbsp
        <a style="color:#0099FF; font-size:15px; text-decoration: 0;" href=comment_del.php?id={$data['id'] }&URL="上海宋庆龄故居_30.php">删除</a>
    <span>
    </div>
    </div>
    </div>
    ...
    <div class="js">
        <div class="jianjie">
            <div class="words">
                <h3>简介</h3>
                <p>
                    上海宋庆龄故居位于上海市淮海中路1843号，是伟人宋庆龄长期居住和从事国务活动的重要场所。故居总面积4300多平方米，分为前花园，主楼和后花园。 上海宋庆龄故居是宋庆龄一生中居住时间最长的地方，也是她从事国务活动的重要场所，留下了许多珍贵的历史瞬间和大量文物。
                </p>
                <p>
                    1949年宋庆龄就是在这里欣然接受中国共产党的邀请，北上参加开国大典和第一届中国人民政治协商会议，并当选为中央人民政府副主席，参与制定国家各项大政方针。她经常在故居举行各种国务活动，会晤和宴请来访的各国贵宾，促进中外交往维护世界和平。
                </p>
                <p>
                    她所创建的新中国妇幼文化福利事业和对外宣传刊物也是在这里酝酿、筹划的。她也曾在故居内会见过许多党和国家领导人如毛泽东、刘少奇、周恩来、邓小平、朱德、陈毅等。
                </p>
            </div>
            <div class="img">
                <img src="image/宋庆龄故居/简介.jpg" alt="简介">
            </div>
        </div>
        <div class="main">
            <div class="scen1">
                <div class="img">
                    <img src="image/宋庆龄故居/主体建筑.jpg" alt="主体建筑">
                </div>
                <div class="words">
                    <h4>主体建筑</h4>
                    <p>
            ...
            <div class="scen2">
                <div class="words">
                    <h4>历史事迹</h4>
                    <p>
                        宋庆龄于1948年底迁到这里居住。1981年5月29日宋庆龄在北京逝世。 1981年10月，故居被列为上海市重点文物保护单位。故居内的陈设保持宋庆龄生前原样。楼下过厅墙上挂着徐悲鸿赠送的“奔马”国画，还有国际友人赠送的风景油画，客厅背面墙上挂着孙中山先生的遗像，南面墙上挂着毛泽东主席1961年来此看望她时的留影，客厅西面的餐厅里陈放着她个人生活经历中的重要纪念品和各国友人赠送的珍贵礼品。
                    </p>
                </div>
                <div class="img">
                    <img src="image/宋庆龄故居/历史事迹.jpg" alt="历史事迹">
                </div>
            </div>
            <div class="scen3">
                <div class="img">
                    <img src="image/宋庆龄故居/陈设简朴.jpg" alt="陈设简朴">
                </div>
                <div class="words">
                    <h4>陈设简朴</h4>
                    <p>
                        在这间陈设简朴的小餐厅里，宋庆龄还宴请过来访的贵宾。书房中收藏着孙中山先生演讲的珍贵录音 唱片和孙中山亲笔题字的遗著，还有中外图书4000余册。二楼是卧室和办公室，室内的一套藤木家具是宋庆龄结婚时父母送给她的嫁妆，沙发和茶几是孙中山先生使用过的。室内摆放着孙中山18岁时的照片和孙中山逝世前一年与宋庆龄的合影。书桌上放着她生前使用过的文具用品。室内还存放着一架钢琴。 二楼走廊里挂着宋庆龄1951年接受“加强国际和平斯大林奖金”时的照片。楼下车库里还停放着斯大林赠送的一辆“吉姆”牌轿车。
                    </p>
                </div>
            </div>
        </div>
...
<body>
    ...
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="上海宋庆龄故居_30.php?view='intro'">看介绍</a> 
    </div>
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="上海宋庆龄故居_30.php?view='comment'">看评论</a>
    </div>
    <?php
    if(!isset($_GET['view']))
    {
...
function opHeader()
{
    ...
    <link rel="stylesheet" href="css/上海宋庆龄故居.css">
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container" style="font-family: '微软雅黑'">
            <a class="navbar-brand justify-content-start" href="#" style="font-size: 30px">宋庆龄故居</a>
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" style="border-top: 1px; border-color:RGB(248,249,250);">
                            其他景点</a>
                        <div class="dropdown-menu"> <a class="dropdown-item" href="上海植物园_32.php">上海植物园</a> <a class="dropdown-item" href="上海宋庆龄故居_30.php">宋庆龄故居</a>
