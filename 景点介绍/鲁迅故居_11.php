...
if(isset($_POST['comment'])&&$_POST['comment']!="")
{
    ...
    execute($link,$query);
    unset($_POST['comment']);
    header("location:鲁迅故居_11.php?view='comment'");
}
opHeader();
if(!isset($_GET['view']))
{
...
<div  style="font-size:15px;margin:0px auto 0px 550px;">
    <a style="color:#00CCFF;text-decoration: 0;"href=鲁迅故居_11.php?sortWay="time"&view="comment">按时间</a>
    &nbsp|&nbsp
    <a style="color:#00CCFF;text-decoration: 0;"href=鲁迅故居_11.php?sortWay="likes"&view="comment">按赞数</a>
</div>
<br/>
</div>
A;
...
while ($data=mysqli_fetch_assoc($result))
{
    ...
    <div class="thumb">
    <a id={$thumbId} href=comment_like.php?id={$data['id'] }&URL="鲁迅故居_11.php">
    ...
    <span style="color:gray";font-size:10px;>{$data['time']}&nbsp&nbsp&nbsp
        <a style="color:#0099FF; font-size:15px; text-decoration: 0;" href=comment_del.php?id={$data['id'] }&URL="鲁迅故居_11.php">删除</a>
    <span>
    </div>
    </div>
    </div>
    ...
    <div class="js">
        <div class="jianjie">
            <div class="words">
                <h3>简介</h3>
                <p>
                    鲁迅1927年10月从广州来到上海，到1936年10月19日逝世，在上海整整生活了九年。
                    在上海期间他陆续出版了9本杂文集和历史小说集《故事新编》，先后编辑《语丝》、
                    《奔流》、《朝花》、《萌芽》、《前哨》、《十字街头》、《译文》等文学刊物，
                    翻译了许多外国文学作品，1929年主编《科学的艺术论丛书》。
                    他拥护中国共产党提出的抗日民族统一战线的方针，提出“民族革命战争的大众文学”的口号。
                </p>
                <p>
                    1930年鲁迅参加发起并组织成立了中国左翼作家联盟，担任“左联”领导工作。
                    期间，还参加了中国自由运动大同盟、中国民权保障同盟等组织、与国民党和帝国主义进行了长时期坚决的斗争。
                </p>
                <p>
                    鲁迅在上海先住在虹口区横浜路景云里。1933年4月鲁迅搬至现山阴路132弄（原施高塔路大陆新村）9号，这是鲁迅在上海最后的寓所。
                </p>
            </div>
            <div class="img">
                <img src="image/鲁迅故居/luxunguju3.jpg" alt="鲁迅故居">
            </div>
        </div>
        <div class="lishi">
            <div class="img">
                <img src="image/鲁迅故居/luxunguju2.jpg" alt="鲁迅故居">
            </div>
            <div class="words">
                <h3>历史</h3>
                <p>
                    鲁迅故居在抗日战争期间，被日侨占住。抗战胜利后，一度为茶叶专家吴觉农寓所的一部分。
                </p>
                <p>
                    1949年让与民生实业公司，作为该公司投资的太平洋轮船公司的职工宿舍。
                </p>
                <p>
                    1950年春，华东军政委员会批准华东文化部筹建上海鲁迅纪念馆时，决定恢复鲁迅故居。同年9月征用了大陆新村9号，
                    经政务院总理周恩来批准，鲁迅夫人许广平（时为政务院副秘书长）来沪指导筹建。经多方调查核实，在许广平指导下恢复。
                </p>
                <p>
                    1951年1月7日作为上海鲁迅纪念馆的组成部分对外开放，1952年5月改为内部开放，1989年3月起对外开放。 
        ...
        <div class="yishi">
            <div class="words">
                <h3>轶事</h3>
                <p>
                    鲁迅在这里先后编选他的历史小说《故事新编》，和《伪自由书》、《南腔北调集》、《准风月谈》、《花边文学》、
                    《且介亭杂文》等7本杂文集，翻译了《表》、《死魂灵》、《俄罗斯的童话》等4本外国文学作品，编印出版了《木刻纪程》、
                    《引玉集》、《凯绥·珂勒惠支版画选集》等中外版画；编校出版了瞿秋白的译文集《海上述林》上下卷。
                    鲁迅在这里会见过瞿秋白、茅盾、冯雪峰和A·史沫特莱、内山完造等中外著名人士。因鲁迅故居地为“越界筑路”地区，
                    具有半租界性质。鲁迅以“租界”两字的一半命名自己的书斋为“且介亭”。后间是贮藏室，有1只瞿秋白留下的红色破皮板箱，
                    两边的木箱盛放着鲁迅举办版画展览时的镜框，1只多层用品橱，内有鲁迅的修书工具、药品和医疗器皿等各种什物。
                </p>
            </div>
            <div class="img">
                <img src="image/鲁迅故居/luxunguju1.jpg" alt="鲁迅故居">
            </div>
        </div>
    </div>
    A;
...
<body>
    ...
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="鲁迅故居_11.php?view='intro'">看介绍</a> 
    </div>
    <div class="anniu">
        <a style="text-decoration:0;color:rgba(0, 0, 0)" href="鲁迅故居_11.php?view='comment'">看评论</a>
    </div>
    <?php
    if(!isset($_GET['view']))
    {
...
function opHeader()
{
    ...
    <style>
        *{
        ...
        body {
            background-size: 100%;
            background-image: url(image/鲁迅故居/luxunguju.jpg);
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container" style="font-family: '微软雅黑'">
            <a class="navbar-brand justify-content-start" href="#" style="font-size: 30px">鲁迅故居</a>
